...
/**
 * Enhanced Playwright API Client Utility
 ...
 *
 * Usage Examples:
 * - POST: PlaywrightApiClient.post(requestContext, "/users", payload, headers).expectStatus(201)
 * - GET: PlaywrightApiClient.get(requestContext, "/users/1", headers).expectStatus(200).parseJson()
 * - PUT: PlaywrightApiClient.put(requestContext, "/users/1", payload, headers).validateResponse()
 * - DELETE: PlaywrightApiClient.delete(requestContext, "/users/1", headers).expectStatus(204)
 */
public class PlaywrightApiClient {
    ...
    public static class ApiResponse {
        ...
        /**
         * Get raw Playwright response object
         */
