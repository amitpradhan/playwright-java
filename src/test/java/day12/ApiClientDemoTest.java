...
import utils.api.PlaywrightApiClient.ApiResponse;
...
/**
 * Example test class demonstrating the usage of PlaywrightApiClient utility
...
public class ApiClientDemoTest {
    ...
    @BeforeClass
    public void setup() {
        LogUtils.info("Setting up test environment with PlaywrightApiClient...");
    ...
    public void testPostRequestWithFluentApi() {
        ...
        ApiResponse response = PlaywrightApiClient.post(requestContext, "/v1/users", payload, headers)
    ...
    public void testGetRequestWithJsonParsing() {
        ...
        ApiResponse response = PlaywrightApiClient.get(requestContext, "/v1/users/" + createdUserId, headers)
                .expectSuccess()
    ...
    public void testPutRequestUpdate() {
        ...
        // Execute PUT request
        ApiResponse response = PlaywrightApiClient.put(
                requestContext, 
    ...
    public void testDeleteRequestRemove() {
        ...
        ApiResponse response = PlaywrightApiClient.delete(requestContext, "/v1/users/" + createdUserId, headers)
                .expectSuccess();
    ...
    public void testBearerTokenAuthentication() {
        ...
        Map<String, String> headers = PlaywrightApiClient.buildHeadersWithBearerToken("your_token_here");
    ...
    public void testFormEncodedPost() {
        ...
        ApiResponse response = PlaywrightApiClient.postFormEncoded(
                requestContext,
                "/oauth/token",
                formData,
                headers
